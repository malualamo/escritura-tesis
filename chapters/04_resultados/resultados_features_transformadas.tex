...
En los resultados de \feat{saliencia\_media} se puede observar cómo la señal de la versión logarítmica es más limpia que la señal de la escala original, aunque con menor amplitud. La topografía negativa occipital aparece más concetrada y localizada. Sin embargo, el cluster TFCE es considerablemente más pequeño y acotado que en la versión original, lo que contrasta con el patrón observado en el resto de las features transformadas. La activación pre-onset presente en la versión original no se observa en la versión logarítmica.
