...
\feat{saliencia\_pixel\_log} mantiene un cluster negativo de distribución 
amplia en una ventana similar a la observada en escala original 
($\sim$0--200 ms), lo que indica que la transformación logarítmica 
preserva el patrón de activación sin modificar sustancialmente su 
...
\feat{saliencia\_media\_log} presenta un cluster negativo, pero de 
extensión considerablemente más acotada respecto a su versión original: 
mientras que en escala original el cluster abarcaba una ventana amplia 
de 0--200 ms con distribución generalizada, la versión transformada 
muestra un cluster reducido a aproximadamente 80--120 ms. Este resultado 
sugiere que, pese a la mejora en la simetría distribucional, la 
transformación logarítmica no mejora la detección de efectos 
significativos para esta feature.
...
\feat{similitud\_pixel\_log} presenta 
un cluster negativo levemente más acotado respecto a su versión original, 
concentrado entre 80--180 ms.
...
\feat{similitud\_media\_log} \todo{Análisis de diferencias entre original y transformada}
...
\feat{ganancia\_informacion\_log} \todo{Análisis de diferencias entre original y transformada}
...
\feat{gap\_entropia\_log} \todo{Análisis de diferencias entre original y transformada}
