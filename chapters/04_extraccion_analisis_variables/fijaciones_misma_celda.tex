...
% todas las variables, lo que introduciría repetición artificial en 
...
% 
% La Tabla~\ref{tab:misma_celda} presenta, para cada variable, el número 
...
% \begin{tabular}{lrrr}
% \toprule
% \textbf{Variable} & \textbf{Idénticas} & \textbf{Distintas} & \textbf{\% idénticas} \\
% \midrule
% \feat{saliencia\_media}               & 2.908 & 0     & 100.0\% \\
% \feat{saliencia\_mediana}             & 2.908 & 0     & 100.0\% \\
% \feat{similitud\_media}               & 2.908 & 0     & 100.0\% \\
% \feat{similitud\_mediana}             & 2.908 & 0     & 100.0\% \\
% \feat{entropia\_prior\_saliencia}     & 2.908 & 0     & 100.0\% \\
% \midrule
% \feat{competencia\_densidad}          & 1.943 & 965   & 66.8\%  \\
% \feat{competencia\_densidad\_norm}    & 1.943 & 965   & 66.8\%  \\
% \feat{saliencia\_pixel}               & 1.596 & 1.312 & 54.9\%  \\
% \feat{similitud\_pixel}               & 1.101 & 1.807 & 37.9\%  \\
% \feat{distancia\_grilla}              & 197   & 2.711 & 6.8\%   \\
% \feat{distancia\_pixels}              & 197   & 2.711 & 6.8\%   \\
% \feat{gap\_entropia}                  & 24    & 2.884 & 0.8\%   \\
% \midrule
% \feat{evidencia\_visual}              & 0     & 2.908 & 0.0\%   \\
% \feat{competencia\_fp\_var}           & 0     & 2.908 & 0.0\%   \\
% \feat{competencia\_fp\_media}         & 0     & 2.908 & 0.0\%   \\
% \feat{competencia\_fp\_max}           & 0     & 2.908 & 0.0\%   \\
% \feat{posterior}                      & 0     & 2.908 & 0.0\%   \\
% \feat{entropia\_posterior}            & 0     & 2.908 & 0.0\%   \\
% \feat{ganancia\_informacion}          & 0     & 2.908 & 0.0\%   \\
% \feat{competencia\_ratio}             & 0     & 2.908 & 0.0\%   \\
% \bottomrule
% \end{tabular}
% \end{table}
% 
% El primer grupo corresponde a las variables con valores idénticos en 
% el $100\%$ de los pares: \feat{saliencia\_media}, 
% \feat{saliencia\_mediana}, \feat{similitud\_media}, 
% \feat{similitud\_mediana} y \feat{entropia\_prior\_saliencia}. 
% Estas variables dependen únicamente de la celda y de la imagen, por 
...
% estática.
% 
% El segundo grupo corresponde a las variables con valores siempre 
% distintos ($0\%$ de idénticas): \feat{evidencia\_visual}, 
% \feat{competencia\_fp\_var}, \feat{competencia\_fp\_media}, 
% \feat{competencia\_fp\_max}, \feat{posterior}, 
% \feat{entropia\_posterior}, \feat{ganancia\_informacion}, 
% \feat{gap\_entropia} y \feat{competencia\_ratio}. Para estas 
% variables, los mapas internos del modelo nnELM se actualizan en 
...
% distintos.
% 
% El tercer grupo corresponde a variables con comportamiento intermedio, 
% que merecen una explicación particular. \feat{saliencia\_pixel} 
% ($54.9\%$) y \feat{similitud\_pixel} ($37.9\%$) dependen del 
...
% valor por coincidencia. Finalmente, \feat{distancia\_grilla} y 
% \feat{distancia\_pixels} presentan un $6.8\%$ de valores idénticos, 
...
% variables dinámicas no presentan valores idénticos en esos pares, 
