...
El framework de TRFs por Regresión Regularizadas representa la señal EEG de cada electrodo como una combinación lineal de las respuestas a distintos tipos de eventos. Por ejemplo, para un solo predictor $x$ con ventana de $L$ lags:
...
Cómo punto de partida para el análisis, se adopta el modelo base MD2 definido en \citet{care2025}, que incluye los siguientes predictores:
