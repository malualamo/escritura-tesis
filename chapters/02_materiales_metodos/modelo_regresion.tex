...
\subsubsection{El modelo base: MH1}

Cómo punto de partida para el análisis, se adopta el modelo base definido en \todo{cita}, que incluye los siguientes predictores:
