...
Para la evaluación de la contribución de las features extraídas del nnELM se adoptó la estrategia de \textbf{construcción incremental de modelos}. Se utiliza como base el modelo MD2 (Sección~\ref{sec:modelo_regresion}) y se incorpora de forma independiente cada feature candidata. Esta estrategia permite aislar el aporte marginal de cada variable antes de considerar combinaciones.
